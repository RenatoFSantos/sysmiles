...
export const Routes = [
    ...
    { method: 'get', route: '/users', controller: UserController, action: 'allPagination' },
    ...
    { method: 'get', route: '/address', controller: AddressController, action: 'allAddress' },
    ...
    { method: 'get', route: '/anamnesis', controller: AnamnesisController, action: 'allPagination' },
    ...
    { method: 'get', route: '/clinic', controller: ClinicController, action: 'allPagination' },
    ...
    { method: 'get', route: '/clinicexamination', controller: ClinicalExaminationController, action: 'allPagination' },
    ...
    { method: 'get', route: '/clinicdentist', controller: ClinicDentistController, action: 'allPagination' },
    ...
    { method: 'get', route: '/dentist', controller: DentistController, action: 'allPagination' },
    ...
    { method: 'get', route: '/patient', controller: PatientController, action: 'allPagination' },
    ...
    { method: 'get', route: '/sponsor', controller: SponsorController, action: 'allPagination' },

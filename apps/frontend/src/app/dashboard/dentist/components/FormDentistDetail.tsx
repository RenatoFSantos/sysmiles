...
interface FormDentistDetailProps {
    dentist: Dentist;
    btnCancel: () => void;
    btnSave: (dentist: Dentist) => void;
}
...
export default function FormDentistDetail(props: FormDentistDetailProps) {
    const title = props.dentist.user?.uid ? 'Alterar Usuário' : 'Inserir Usuário';
    ...
    useEffect(() => {
        loadingData(props.dentist.user);
    }, []);
                    ...
                    <div className="col-span-10">
                        ...
                        <div className="flex flex-row justify-end items-center mt-5">
                            ...
                            <Botao className={`mr-5 h-1/2 items-center`} cor="cyan" type="form">
                                {props.dentist.uid !== '' ? 'Salvar' : 'Inserir'}
                            </Botao>
                            <Botao
                                className={`h-1/2`}
                                cor="cyan"
